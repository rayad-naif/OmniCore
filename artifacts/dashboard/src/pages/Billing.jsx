    ...
    >
      ...
      {plan.badge && (
        <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
          <span
            className={`px-3 py-1 rounded-full text-[11px] font-bold ${c.badge} shadow-sm`}
          >
            {plan.badge}
          </span>
        </div>
      ...
      <div className="px-5 pb-5">
        {isCurrent ? (
          <div
            className={`w-full py-2 rounded-xl text-xs font-semibold text-center ${c.light} ${c.text}`}
          >
            Your current plan
          </div>
        ) : plan.price == null ? (
          <a
            href="mailto:sales@atelier-omnicore.com"
          ...
          <div className="flex items-start gap-4 px-5 py-4 rounded-2xl bg-red-50 border border-red-300">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-red-700 mt-1">
                ...
                to keep your subscription active. After the grace period, your
                brand widget will be automatically disabled.
              </p>
            </div>
            <button
          ...
          <div className="flex items-start gap-4 px-5 py-4 rounded-2xl bg-slate-50 border border-slate-300">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-slate-600 mt-1">
                ...
                <strong>{fmtDate(subscription.currentPeriodEnd)}</strong>. You
                can re-subscribe at any time before then.
              </p>
            </div>
          </div>
        )}
          ...
          <div className="flex items-start gap-4 px-5 py-4 rounded-2xl bg-blue-50 border border-blue-200">
            ...
            <div>
              ...
              <p className="text-xs text-blue-700 mt-1">
                Trial ends on{' '}
                <strong>{fmtDate(subscription.trialEndsAt)}</strong>. Add a
                payment method to keep your plan active after the trial.
              </p>
            </div>
          </div>
        )}
          ...
          <div className="px-6 py-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <UsageMeter
                ...
                icon="📚"
                used={usage?.articles || 0}
                limit={planLimits.articles}
              />
              <UsageMeter
                label="AI Credits Used"
                icon="🤖"
                used={usage?.aiCredits || 0}
        ...
        <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
          <div className="px-6 py-5 border-b border-slate-100">
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Download past invoices from your billing portal.
            </p>
          </div>
          <div className="flex items-center justify-between px-6 py-5">
            <p className="text-sm text-slate-500">
              View and download all invoices in the Lemon Squeezy customer
              portal.
            </p>
            <button
              onClick={handlePortal}
            ...
            {[
              {
                ...
                a: 'Yes. Cancellations take effect at the end of your current billing period.',
              },
              {
                q: 'What happens if I exceed my limits?',
                a: 'You will receive an in-app warning at 90% usage. AI responses pause at 100%. Upgrade instantly to restore service.',
              },
              {
                q: 'Are unused AI credits rolled over?',
                a: 'No. Credits reset at the start of each billing month.',
              },
              {
                q: 'Do you offer annual billing?',
                a: 'Yes — annual plans save 20%. Contact sales@atelier-omnicore.com for an annual invoice.',
              },
            ].map(({ q, a }) => (
